...
#
#
# class SearchVerifierEX(SearchVerifier):
...
#
#                     veri_flag_container, ce_item = self.verifier.seg_verification([current_set],
#                                                                                   reverse_flag=self.case.reverse_flag)
...
#
#         workers = [multiprocessing.Process(target=self.worker, args=(
#         veri_flag, ce, task_queue, output_queue, boundary_dict, boundary_list, pair_wise_hinge)) for _ in
#                    range(num_workers)]
#
#         for w in workers:
#             w.start()
...
#     #     return prob_S_list
#
#     def SV_init(self, safept, unsafept):
#         result_info = {}
