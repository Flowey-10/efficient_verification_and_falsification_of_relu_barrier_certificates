...
class QuadraticDecay(ControlAffineSystem):
    ...
    def n_controls(self) -> int:
        return QuadraticDecay.N_CONTROLS
    ...
    def state_limits(self) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        upper_limit[QuadraticDecay.X] = 2.0
        upper_limit[QuadraticDecay.Y] = 2.0
    ...
    def unsafe_mask(self, x):
        ...
        h = x[:, QuadraticDecay.X] + x[:, QuadraticDecay.Y] ** 2
    ...
    def _f(self, x: torch.Tensor, params: Scenario):
        ...
        x0_ = x[:, QuadraticDecay.X]
        x1_ = x[:, QuadraticDecay.Y]
        x2_ = x[:, QuadraticDecay.Z]

        f[:, QuadraticDecay.X, 0] = -x0_ + x1_ ** 2
        f[:, QuadraticDecay.Y, 0] = -x1_ + x2_ ** 2
        f[:, QuadraticDecay.Z, 0] = -x2_ + x0_ ** 2
