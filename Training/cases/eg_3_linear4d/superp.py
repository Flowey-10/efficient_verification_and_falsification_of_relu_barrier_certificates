...
DATA_EXP_I = np.array([5, 5, 5, 5]) # for sampling from initial; length = prob.DIM
DATA_LEN_I = np.power(2, DATA_EXP_I) # the number of samples for each dimension of domain
BLOCK_EXP_I = np.array([3, 3, 3, 3]) # 0 <= BATCH_EXP <= DATA_EXP
...
DATA_EXP_D = np.array([4, 4, 4, 4]) # for sampling from initial; length = prob.DIM
DATA_LEN_D = np.power(2, DATA_EXP_D) # the number of samples for each dimension of domain
BLOCK_EXP_D = np.array([2, 2, 2, 2]) # 0 <= BATCH_EXP <= DATA_EXP
