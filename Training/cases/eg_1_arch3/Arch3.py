...
class Arch3(ControlAffineSystem):
    ...
    def state_limits(self) -> Tuple[torch.Tensor, torch.Tensor]:
        ...
        upper_limit[Arch3.X] = 2.0
        upper_limit[Arch3.Y] = 2.0
    ...
    def _f(self, x: torch.Tensor, params: Scenario):
        ...
        f[:, Arch3.X, 0] = x0_ - x0_ ** 3 + x1_ - x0_ * x1_ ** 2
        f[:, Arch3.Y, 0] = -x0_ + x1_ - x0_ ** 2 * x1_ - x1_ ** 3
